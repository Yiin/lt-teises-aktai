...
statusas: galioja
etar_url: "https://e-tar.lt/portal/lt/legalAct/1fd390409beb11ea9515f752ff221ec9"
---
...
12. LRT naudojamuose kanaluose be Tarybos leidimo neleidžiama veikti kitoms radijo ir televizijos stotims.
...
8. Taryba turi teisę atsistatydinti in corpore nepasibaigus Tarybos narių kadencijai. Jeigu Taryba atsistatydina in corpore, visų Tarybos narių įgaliojimai nutrūksta, kai iš naujo sudaryta Taryba susirenka į pirmąjį posėdį. 
...
5. Taryba turi teisę siųsti savo atstovus į LRT administracijos posėdžius, taip pat gauti iš LRT administracijos, LRT vidaus audito tarnybos, LRT etikos kontrolieriaus, valstybės ir savivaldybių institucijų ir įstaigų informaciją, būtiną Tarybos funkcijoms atlikti.
...
2. LRT generalinis direktorius gauna Tarybos nutarimus ir su jais susipažįsta, taip pat susipažįsta su LRT etikos kontrolieriaus, LRT vidaus audito tarnybos vadovo ataskaitomis, kita informacija, būtina jo funkcijoms atlikti, be balsavimo teisės gali dalyvauti Tarybos ir komitetų posėdžiuose.




3. LRT generalinis direktorius rengia ir teikia Tarybai tvirtinti metinę LRT veiklos ataskaitą.
 
...
7. LRT etikos kontrolieriaus įgaliojimai nutrūksta, kai:
...
8. LRT etikos kontrolieriui darbo užmokestis mokamas iš LRT lėšų. Lėšos, skirtos LRT etikos kontrolieriui, turi būti numatytos LRT metinėje pajamų ir išlaidų sąmatoje ir naudojamos šio įstatymo numatytoms LRT etikos kontrolieriaus funkcijoms atlikti.
 
...
3. LRT etikos kontrolieriaus funkcijos, teisės ir pareigos bei darbo organizavimo tvarka nustatomos LRT etikos kontrolieriaus veiklos nuostatuose, kuriuos tvirtina Taryba.




4. LRT etikos kontrolieriaus sprendimai dėl profesinės etikos ar kitų pažeidimų turi būti skelbiami LRT interneto svetainėje.
 
...
8. LRT vidaus audito tarnybos vadovui darbo užmokestis mokamas iš LRT lėšų. Lėšos, skirtos LRT vidaus audito tarnybos veiklai užtikrinti, turi būti numatytos LRT metinėje pajamų ir išlaidų sąmatoje ir naudojamos tik įstatymų numatytoms LRT vidaus audito tarnybos funkcijoms atlikti.
 
...
7. LRT turtu negalima užtikrinti trečiųjų asmenų prievolių vykdymo.
 
...
2. Įsigaliojus šiam įstatymui paskirtas LRT etikos kontrolierius ne vėliau kaip per 3 mėnesius po to, kai pradeda eiti pareigas, teikia Tarybai tvirtinti LRT žurnalistų etikos kodeksą. 




3. Klausos ir regos negalią turintiems asmenims pritaikytų LRT televizijos programų transliavimo laikas ilginamas nuosekliai šios dalies 1, 2 ir 3 punktuose nurodyta tvarka, iki bus pasiekta šio įstatymo 1 straipsnyje išdėstyto Lietuvos Respublikos Lietuvos radijo ir televizijos įstatymo 5 straipsnio 10 dalyje nurodyta minimali jų transliavimo trukmė:
...
2) programų, verčiamų į lietuvių gestų kalbą, transliavimo trukmė per mėnesį, palyginti su LRT televizijos programų, verčiamų į lietuvių gestų kalbą, transliavimo trukme per mėnesį 2019 m., kiekvienais metais ilginama ne mažiau kaip vienu procentu viso transliavimo laiko;
