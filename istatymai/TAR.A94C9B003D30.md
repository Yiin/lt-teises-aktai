...
statusas: galioja
etar_url: "https://e-tar.lt/portal/lt/legalAct/TAR.A94C9B003D30"
---
...
Netinkamų naudoti pesticidų utilizavimas ir nukenksminimas,
  kitos programos (vandens ir atmosferos apsauga, kraštovaizdžio apsauga,
  žuvivaisa ir žuvisauga, aplinkos monitoringas ir kitos)
...
Geologinio kartografavimo, informacinės sistemos sukūrimo,
  litosferos monitoringo, naudingųjų iškasenų tyrimų ir kitos programos
...
Standartizuotų terminų bazės programinei įrangai sukurti
...
Narkomanijos prevencija, policijos įstatymų rengimas ir kita
...
 
SAVIVALDYBIŲ
BIUDŽETAMS  SKIRIAMO FIZINIŲ ASMENŲ PAJAMŲ MOKESČIO DALYS, VALSTYBĖS BIUDŽETO
BENDROJI DOTACIJA MOKESTINĖMS PAJAMOMS IR IŠLAIDŲ STRUKTŪROS SKIRTUMAMS
IŠLYGINTI 
 
...
Valstybės
  biudžeto bendroji dotacija (tūkst. Lt) 
...
Asignavimams,
  susijusiems su savininkams grąžintais ir grąžintinais gyvenamaisiaisnamais


Savivaldybių
  bibliotekų darbuotojų darbo užmokesčiui
