...
isigaliojimo_data: 1996-12-04
paskelbimo_data: 1996-11-19
statusas: galioja
etar_url: "https://e-tar.lt/portal/lt/legalAct/TAR.3CD1008B88A9"
---
...
Valstybės institucijos, visų rūšių bei nuosavybės formų įmonės, įstaigos, organizacijos ir piliečiai, vadovaudamiesi šiuo įstatymu ir Vyriausybės nustatyta tvarka, privalo dalyvauti rengiant mobilizacinį rezervą ir užtikrinant mobilizaciją.
 
...
3) aprangos ir ekipuotės gamyba, užpirkimas, paskirstymas bei saugojimas;
...
10) transporto ir kitos technikos rekvizicijų planavimas, vykdymas ir finansavimas.
...
3. Mobilizacija organizuojama pagal valstybės mobilizacinį planą.
 
...
2) įgyvendindamas jam suteiktus įgaliojimus, leidžia aktus-dekretus.
...
2) įgyvendindamas šios dalies 1 punkte išvardytus įgaliojimus, priima nutarimus;
...
4) išklauso Vyriausybės ir krašto apsaugos ministro ataskaitas už pasirengimą mobilizacijai ir mobilizacinio rezervo rengimą.
...
1) tvirtina valstybės mobilizacinį ir gynybos planus;




2) atsako už valstybės mobilizacinio plano įgyvendinimą;




3) tvirtina kariuomenės mobilizacinį planą;
...
1) rengia ginklų ir kovinės technikos įsigijimo programas;
...
2) pagal joms pavestas mobilizacines užduotis sudaro mobilizacinius planus;




3) teikia Krašto apsaugos ministerijai duomenis apie jų reguliavimo sričiai priskirtų valstybės įmonių ir specialios paskirties akcinių bendrovių turimus materialinius ir finansinius išteklius bei gamybos pajėgumus.
...
1) atsako už joms pavestų valstybinių mobilizacinių užduočių vykdymą;
...
4) užtikrina savo mobilizacinio plano vykdymo finansavimą.
 
...
1) atsako už gautų valstybinių mobilizacinių užsakymų vykdymą;
...
3) palaiko nustatytos parengties mobilizacinį rezervą;
...
1. Mobilizacinį karo prievolininkų rezervą sudaro visi atsargos karo prievolininkai.




2. Atsargos karo prievolininkų apskaitos ir mokymo tvarką nustatyto Karo prievolės įstatymas.




3. Vietinė teritorinė karinė įstaiga išsiunčia registruotu laišku atsargos karo prievolininkams mobilizacinius šaukimus, kuriuose, be kitos informacijos, nurodomas kodas, kurį paskelbus, atsargos karo prievolininkai per nustatytą laiką turi atvykti į nurodytus punktus.
 
...
13 straipsnis. Mobilizacinių planų turinys


Mobilizaciniai planai nustato:


1) mobilizacijos vykdymo tvarką;




2) mobilizacinių atsargų kaupimą, paruošimą ir naudojimą;




3) mobilizacinius mokymus.
 
...
16 straipsnis. Atsakomybė už šio įstatymo pažeidimą
