---
tar_id: TAR.ED61EE3E773F
dok_nr: VIII-1949
pavadinimas: Lietuvos Respublikos laisvųjų sandėlių įstatymas
rusis: istatymas
...
statusas: negalioja
etar_url: "https://e-tar.lt/portal/lt/legalAct/TAR.ED61EE3E773F"
---

# Lietuvos Respublikos laisvųjų sandėlių įstatymas
...
Šis įstatymas nustato laisvųjų sandėlių steigimo ir veiklos tvarką.
...
2. Kitos sąvokos šiame įstatyme vartojamos tokia reikšme kaip Muitinės kodekso 2 straipsnyje pateiktos sąvokos.
...
7. Kai atšaukiamas leidimas steigti laisvąjį sandėlį, jo veikla nutraukiama. Leidimas steigti laisvąjį sandėlį atšaukiamas Vyriausybės arba jos įgaliotos institucijos nustatyta tvarka, jeigu:
   1) nustatytas pakartotinis prekių dingimas iš laisvojo sandėlio;
   ...
   4) per vienerius metus nuo leidimo steigti laisvąjį sandėlį išdavimo dienos jis nepradėjo veikti;
   5) per tris mėnesius nepašalinti laisvojo sandėlio veiklos trūkumai, dėl kurių sustabdytas leidimo steigti laisvąjį sandėlį galiojimas.
...
1. Gavusi leidimą steigti laisvąjį sandėlį, po 10 darbo dienų įmonė gali pradėti jo veiklą, jeigu įvykdytos šios sąlygos:
   1) pateikta šio įstatymo 3 straipsnio 5 dalyje nurodyta garantija;
   2) suderinti šio įstatymo 3 straipsnio 6 dalyje nurodyti su laisvojo sandėlio muitinės priežiūra susiję klausimai.
2. Vyriausybė arba jos įgaliota institucija gali nustatyti:
   ...
   2) tam tikrų prekių laikymo laisvajame sandėlyje terminus.
...
7. Laisvajame sandėlyje privaloma laikytis šių prekių apskaitos reikalavimų:
   1) į laisvąjį sandėlį padėtos prekės turi būti tuojau pat įtrauktos į apskaitą;
   ...
   3) Lietuvos ir ne Lietuvos prekės turi būti įtraukiamos į apskaitą atskirai.
8. Muitinė turi teisę:
   ...
   5) papildomai plombuoti laisvojo sandėlio patalpas (įvažiavimo vartus) muitinės plombomis;
   ...
   7) inventorizuoti laisvajame sandėlyje laikomas prekes;
   8) kontroliuoti laisvojo sandėlio prekių apskaitą;
   9) atlikti kitą įstatymų ir kitų teisės aktų nustatytą laisvojo sandėlio priežiūrą.
...
11. Kai muitinės sprendimu sustabdytas leidimo steigti laisvąjį sandėlį galiojimas dėl nustatytų laisvojo sandėlio veiklos trūkumų, prekes dėti į laisvąjį sandėlį ir išduoti iš jo draudžiama.

#### 6 straipsnis. Laisvųjų sandėlių muitinės priežiūra, prekių padėjimo, laikymo, išdavimo ir apskaitos tvarka
Laisvųjų sandėlių muitinės priežiūros, prekių padėjimo į laisvuosius sandėlius, laikymo ir naudojimo juose, apskaitos ir išdavimo iš laisvųjų sandėlių tvarką nustato Muitinės kodeksas ir jo taikymą reglamentuojantys teisės aktai.

#### 7 straipsnis. Atsakomybė už šio įstatymo pažeidimus
Pažeidę šį įstatymą fiziniai ir juridiniai asmenys bei juridinio asmens teisių neturinčios įmonės atsako įstatymų nustatyta tvarka.
