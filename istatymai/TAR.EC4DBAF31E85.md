...
statusas: galioja
etar_url: "https://e-tar.lt/portal/lt/legalAct/TAR.EC4DBAF31E85"
---
...
Pakeisti ir papildyti Lietuvos Respublikos žemės ūkio bendrovių įstatymą (Žin., 1991, Nr. 13-328; 1992, Nr. 14-386; 1993, Nr. 7-140, Nr. 52-997, Nr. 62-1169):
...
2) pirmąją dalį papildyti 9 punktu:
...
1) trečiosios dalies pirmajame sakinyje vietoj skaičių „2/3“ įrašyti žodžius „daugiau kaip pusė“;
...
3. 11 straipsnio pirmosios dalies 7 punktą išdėstyti taip:
...
4. 14 straipsnio trečiąją, ketvirtąją ir penktąją dalis išdėstyti taip:
...
5. 15 straipsnį papildyti 5 punktu:
...
6. 16 straipsnį papildyti 4 punktu:
...
7. 17 straipsnio antrąją dalį išdėstyti taip:
...
8. 19 straipsnio antrąją dalį papildyti antrąja pastraipa:
...
1) trečiosios dalies antrąją pastraipą išdėstyti taip:
...
2) įrašyti tokią ketvirtąją dalį:
...
3) buvusias ketvirtąją ir penktąją dalis laikyti atitinkamai penktąja ir šeštąja dalimis.
...
10. 21 straipsnyje po žodžių „bei administracijos vadovas“ įrašyti žodžius „(pirmininkas, direktorius)“.
...
1) antrosios dalies 2 punktą išdėstyti taip:
...
2) antrosios dalies 7 punktą laikyti netekusiu galios;
...
2) antrąją dalį papildyti tokiu sakiniu:




„Administracijos vadovas skiriamas tokia tvarka kaip ir valdybos pirmininkas.“
...
13. 26 straipsnio antrąją dalį išdėstyti taip:
...
14. 32 straipsnio pirmosios dalies pirmąjį ir antrąjį sakinius išdėstyti taip:




„Apie bendrovės likvidavimą likvidatoriai paskelbia viešai spaudoje du kartus su 15 dienų pertrauka ir praneša kiekvienam pajininkui raštu. Kreditorių reikalavimai ir pretenzijos priimami 3 mėnesius nuo likvidavimo antrojo paskelbimo dienos.“
