---
tar_id: TAR.D65FBAE9B378
dok_nr: I-784
pavadinimas: Lietuvos Respublikos visuomeninių organizacijų įstatymas
rusis: istatymas
leidziantis_organas: Lietuvos Respublikos Seimas
priemimo_data: 1995-02-02
isigaliojimo_data: 1995-03-01
paskelbimo_data: 1995-02-02
statusas: negalioja
etar_url: "https://e-tar.lt/portal/lt/legalAct/TAR.D65FBAE9B378"
---
...
 
1. Šis įstatymas nustato visuomeninių
organizacijų steigimo, veiklos ir veiklos pasibaigimo pagrindus.
 2. Įstatymas netaikomas politinėms
...
samprata
 
1. Visuomeninė organizacija - tai Lietuvos
...
2. Draudžiama steigtis ir veikti
...
3. Neleidžiama steigti visuomeninių
...
4. Visuomeninės organizacijos valdymo organai
ir buveinė turi būti Lietuvos Respublikos teritorijoje.
5. Visuomeninių organizacijų raštvedyba
...
steigimas
 
1. Visuomeninių organizacijų steigėjais gali
būti šio įstatymo 2 straipsnio 1 dalyje išvardyti fiziniai asmenys, kuriems yra
sukakę 18 metų.
2. Visuomeninės organizacijos steigimo
...
3. Lietuvos Respublikoje gali būti steigiami
...
3. Visuomeninė organizacija, įsteigusi
...
sąjungos
 
1. Visuomeninės organizacijos turi teisę
vienytis į visuomeninių organizacijų sąjungas.
2. Visuomeninių organizacijų sąjungą gali
steigti dvi ar daugiau visuomeninių organizacijų.
3. Visuomeninių organizacijų sąjungos
...
5. Visuomeninei organizacijai atstovauja jos
įstatuose nurodytas ir įstatuose nustatyta tvarka išrinktas asmuo.
6. Visuomeninės organizacijos įstatuose
...
įstatai
 
1. Visuomeninės organizacijos įstatuose turi
būti numatyta:
...
tvarka.
2. Įstatuose gali būti numatytos ir kitos
...
 3. Jeigu priėmus naujus įstatymus
...
teisės
 
1. Visuomeninių organizacijų įstatuose
...
8) steigti fondus.
2. Visuomeninės organizacijos įstatymų
...
nuosavybė
 
1. Visuomeninėms organizacijoms nuosavybės
...
4. Visuomeninių organizacijų turtas ir lėšos
...
nariams.
5. Pasibaigus visuomeninės organizacijos
...
atsakomybė
 
1. Visuomeninė organizacija atsako už savo
prievoles visu jai priklausančiu turtu.
2. Visuomeninė organizacija neatsako už savo
narių prievoles, o nariai neatsako už visuomeninės organizacijos prievoles.
3. Visuomeninė organizacija, padariusi žalą
...
 
1. Su visuomeninių organizacijų samdomais
darbuotojais sudaroma darbo sutartis įstatymų nustatyta tvarka.
2. Asmenys, dirbantys visuomeninėse
...
3. Šiems tikslams visuomeninės organizacijos
...
 
1. Visuomeninės organizacijos, kurios veikla
...
2. Visuomeninės organizacijos, kurios veikla
...
6. Pateikiant pareiškimą įregistruoti
...
sąjungą.
7. Norint įregistruoti tarptautinės
...
8. Įstatus registruojanti valstybės
...
9. Pareiškimą įregistruoti įstatų pakeitimus
...
10. Visuomeninių organizacijų pavadinimo ir
...
11. Visuomeninių organizacijų įstatus
...
 
1. Visuomeninės organizacijos įstatų
...
2. Atidėjusi įstatų registravimą, įstatus
...
3. Pateikus pataisytus įstatus ir kitus
...
dienos.
4. Jeigu registruojant įstatų pakeitimus ir
...
įstatus
 
1. Visuomeninės organizacijos įstatai
...
neatitinka tikrovės.
2. Atsisakius įregistruoti įstatus,
...
3. Atsisakymas registruoti visuomeninės
...
 
1. Visuomeninių organizacijų finansinę veiklą
kontroliuoja valstybinės mokesčių inspekcijos, kiek tai susiję su mokesčių mokėjimu.
2. Jeigu visuomeninė organizacija gauna lėšų
...
 
1. Valstybės institucija, pagal kompetenciją
...
2. Jeigu per nustatytą terminą pažeidimas
...
3. Jeigu per metus nuo veiklos sustabdymo
...
4. Valstybės institucija, įregistravusi
...
nagrinėjimas
 
1. Skundus dėl visuomeninės organizacijos
...
priėmimo.
2. Valstybės institucija, įregistravusi
...
 
1. Visuomeninės organizacijos veikla gali
pasibaigti:
...
2. Visuomeninių organizacijų reorganizavimo,
...
reorganizavimas
 
1. Sprendimą dėl visuomeninės organizacijos
...
2. Jeigu visuomeninė organizacija
...
3. Visuomeninės organizacijos aukščiausiasis
...
4. Visuomeninei organizacijai pasidalijus į
...
veiklos nutraukimas
 
1. Visuomeninės organizacijos padalinys, taip
...
institucijai.
2. Nuo sprendimo visuomeninės organizacijos
...
organizacija.
3. Visuomeninė organizacija jos įstatuose
...
               pagrindai
 
1. Teismas gali sustabdyti visuomeninės
...
2. Visuomeninės organizacijos, įeinančios į
...
3. Kai visuomeninių organizacijų sąjungos
veikla yra sustabdyta, į ją įeinančios visuomeninės organizacijos veikia tik
pagal savo įstatus.
4. Pasibaigus teismo nustatytam visuomeninės
...
veiklos nutraukimas
 
1. Teismas gali nutraukti visuomeninės
...
2. Teismas, priėmęs sprendimą nutraukti
