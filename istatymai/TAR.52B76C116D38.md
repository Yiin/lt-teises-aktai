---
tar_id: TAR.52B76C116D38
dok_nr: I-490
pavadinimas: "Dėl asmenų, kurie sistemingai daro administracinius teisės pažeidimus būdami apsvaigę nuo alkoholio, narkotinių ar toksinių priemonių, socialinės bei psichologinės reabilitacijos"
rusis: istatymas
leidziantis_organas: Lietuvos Respublikos Seimas
priemimo_data: 1994-06-02
isigaliojimo_data: 1994-08-01
paskelbimo_data: 1994-06-02
statusas: negalioja
etar_url: "https://e-tar.lt/portal/lt/legalAct/TAR.52B76C116D38"
---
...
#### 1 straipsnis
Šis įstatymas reguliuoja socialinės bei psichologinės reabilitacijos taikymą asmenims, kurie, būdami apsvaigę nuo alkoholio, narkotinių ar toksinių priemonių, sistemingai daro administracinius teisės pažeidimus, trikdančius viešąją tvarką ir rimtį.

#### 2 straipsnis
Socialinės bei psichologinės reabilitacijos priemonės yra šios:
   1) individuali profilaktinė vietos savivaldos institucijų pareigūnų ir policijos veikla;
   ...
   4) pasiuntimas į socialinės bei psichologinės reabilitacijos įstaigą.
Šios priemonės gali būti taikomos asmeniui, nepaisant ar buvo taikyta administracinė nuobauda už padarytą administracinį teisės pažeidimą.

#### 3 straipsnis
Socialine bei psichologine reabilitacija norima užkirsti kelią socialinei dezadaptacijai, orientuoti asmenis dorai elgtis, sąžiningai dirbti, įgyti profesiją, taip pat skatinti savanoriškai gydytis nuo alkoholizmo, narkomanijos ar toksikomanijos.

#### 4 straipsnis
Taikant socialinės bei psichologinės reabilitacijos priemones, turi būti laikomasi teisėtumo, humaniškumo, readaptacinių tikslų pirmumo, taip pat medikamentinio gydymo nuo alkoholizmo, narkomanijos ar toksikomanijos savanoriškumo principų.
...
Jeigu asmuo be svarbių priežasčių neatvyksta į policijos nuovadą, tai jis motyvuotu policijos įstaigos vadovo arba jo pavaduotojo nutarimu gali būti atvesdinamas. Atvesdina policija.
...
Policijos įstaigos vadovas arba jo pavaduotojas tuo reikalu kreipiasi į teismą.
...
Į socialinės bei psichologinės reabilitacijos įstaigą teismo nutarimu nuo 6 iki 9 mėnesių gali būti siunčiamas asmuo, įrašytas į policijos įskaitą, jeigu:
   ...
   2) būdamas apsvaigęs nuo alkoholio, narkotinių ar toksinių priemonių, per vienerius metus nuo šio įrašymo dienos padaro vieną administracinį teisės pažeidimą ir neįvykdo policijos nustatytos pareigos per vieną mėnesį pasitikrinti pas narkologą.
...
Jeigu asmuo, kuriam gali būti taikoma ši priemonė, vengia atvykti į teismo posėdį, tai teismas, kad būtų garantuotas šio asmens dalyvavimas teismo posėdyje, gali pavesti policijai jį sulaikyti, bet ne ilgiau kaip 48 valandoms.

#### 13 straipsnis
Teismas, išnagrinėjęs teikimą, priima vieną iš tokių nutarimų:
   1) pasiųsti asmenį į socialinės bei psichologinės reabilitacijos įstaigą;
   2) atmesti teikimą;
   3) pasiųsti asmenį į socialinės bei psichologinės reabilitacijos įstaigą šio nutarimo vykdymą atidedant iki 6 mėnesių.
...
#### 14 straipsnis
Teismo nutarimas gali būti protestuojamas. Protesto padavimo ir nagrinėjimo tvarką nustato Lietuvos Respublikos administracinių teisės pažeidimų kodeksas.
...
Į socialinės bei psichologinės reabilitacijos įstaigą asmuo vyksta su policijos palyda (sargyba).
...
Asmenys, laikomi socialinės bei psichologinės reabilitacijos įstaigoje, turi teisę:
   1) gauti ir siųsti neribotą skaičių laiškų;
   2) gauti neribotą skaičių banderolių su spauda ir knygomis;
   3) gauti neribotą skaičių siuntinių ir perdavimų;
   4) įsigyti maisto produktų ir būtiniausių reikmenų už pinigus, turimus asmeninėse sąskaitose;
   5) dėvėti civilinius drabužius ir avėti civilinę avalynę;
   6) gauti nemokamai maistą pagal Lietuvos Respublikos Vyriausybės nustatytas normas;
   7) gauti neribotą skaičių trumpalaikių – iki 4 valandų – ir ilgalaikių – iki 3 parų – pasimatymų.
Ilgalaikiai pasimatymai suteikiami su artimais giminaičiais ir sutuoktiniu, o gavus įstaigos viršininko leidimą – ir kitais asmenimis.
...
Į bendrojoje socialinės bei psichologinės reabilitacijos įstaigoje laikomų asmenų, kurie įvykdo išdirbio normas ar nustatytas užduotis, asmeninę sąskaitą turi būti įrašoma ne mažiau kaip 25 procentai jiems apskaičiuoto mėnesinio uždarbio.

#### 19 straipsnis
Asmenys, laikomi specialioje socialinės bei psichologinės reabilitacijos įstaigoje, gali dirbti.
...
Asmenys, laikomi šioje įstaigoje, maistu ir apranga aprūpinami nemokamai.
...
Už aktyvią reabilitaciją ir gydymąsi, taip pat už sąžiningą darbą asmenims, laikomiems socialinės bei psichologinės reabilitacijos įstaigoje, gali būti skiriamos šios paskatos:
   1) prieš terminą panaikinama pirmiau paskirta nuobauda;
   2) paskelbiama padėka;
   3) skiriama premija už geriausius darbo rodiklius;
   4) išleidžiama į miestą iki 14 valandų laikui;
   5) teikiama teismui iš socialinės bei psichologinės reabilitacijos įstaigos paleisti prieš terminą.
Asmenims, laikomiems socialinės bei psichologinės reabilitacijos įstaigose, už nustatytų reikalavimų pažeidimą gali būti skiriamos šios nuobaudos;
   ...
   2) be eilės budėjimas tvarkyti įstaigos patalpas ar teritoriją;
   3) uždraudimas vieną mėnesį gauti siuntinius ir perdavimus.
...
Paskatų ir nuobaudų skyrimo pagrindus ir tvarką reglamentuoja vidaus tvarkos taisyklės.
...
Pagal laikomų asmenų kategorijas steigiamos šios socialinės bei psichologinės reabilitacijos įstaigos:
   1) bendrosios – asmenims, anksčiau atlikusiems laisvės atėmimo bausmę;
   2) bendrosios – kitiems asmenims;
   3) specialios – I ir II grupės invalidams, pensinio amžiaus asmenims bei asmenims, sergantiems somatinėmis ligomis, kurių sąrašą tvirtina Lietuvos Respublikos sveikatos apsaugos ministerija.
...
Teismas, atitinkamai motyvuodamas, gali asmenį, anksčiau atlikusį laisvės atėmimo bausmę, pasiųsti į įstaigą, numatytą šio straipsnio pirmosios dalies 2 punkte.
...
Iš specialios socialinės bei psichologinės reabilitacijos įstaigos asmenys teismo nutarimu gali būti perkeliami į bendrąją įstaigą tuo atveju, kai išnyko jų pasiuntimo arba perkėlimo į specialią įstaigą pagrindas ir jie sistemingai pažeidinėjo vidaus tvarkos taisykles.
...
Šių įstaigų nuostatus tvirtina Lietuvos Respublikos Vyriausybė, o vidaus tvarkos taisykles – Vidaus reikalų ministerija, suderinusi su Teisingumo ministerija.
...
Šių įstaigų įrangai gali būti naudojamas inžinerinių ir techninių apsaugos priemonių kompleksas.

#### 27 straipsnis
Socialinės bei psichologinės reabilitacijos įstaigos veikia kaip specifinės paskirties valstybinės įmonės pagal Lietuvos Respublikos valstybinių įmonių įstatymo 1 straipsnį.
...
Asmenų, savavališkai pasišalinusių arba vėluojančių grįžti į socialinės bei psichologinės reabilitacijos įstaigas, paleidimo iš įstaigų klausimas sprendžiamas šio įstatymo 21 straipsnio penktojoje dalyje nustatyta tvarka.
