...
2) dalyvauti savivaldybių tarybų sesijose, valdybų posėdžiuose, kalbėti juose dėl svarstomų projektų teisėtumo, siūlyti atitinkamas pataisas, jeigu projekte yra piliečių ar organizacijų teisių pažeidimų arba prieštaravimų Vyriausybės nutarimams; taip pat reikalauti sustabdyti sprendimo priėmimą, jeigu reikia išsiaiškinti, ar priimamas dokumentas yra teisėtas;
3) teikti informaciją savivaldybių tarybų nariams ir savivaldybių pareigūnams bei kitiems tarnautojams apie Vyriausybės veiklos ekonomines ir socialines, kultūros, švietimo bei ekologines programas, konsultuoti šių programų įgyvendinimą;
4) sistemingai nagrinėti gyventojų pareiškimus bei skundus, juos spręsti pagal savo įgaliojimus arba perduoti spręsti kitiems valstybės ar savivaldybės organams ar pareigūnams pagal šių kompetenciją;
5) susipažinti su Lietuvos Respublikos Seimo ir Vyriausybės dokumentais, raštais, kuriuose sprendžiami atitinkamų savivaldybių reikalai;
6) dalyvauti Lietuvos Respublikos Seimo ir Vyriausybės posėdžiuose, taip pat kituose valstybinių institucijų organizuojamuose renginiuose, kai svarstomi vietos savivaldos ar savivaldybių darbo klausimai.
 

3 straipsnis. Vyriausybės atstovas, nusprendęs, kad savivaldybės tarybos ar valdybos sprendimas, rajono valdytojo, miesto mero, viršaičio potvarkis pažeidžia piliečių ar organizacijų teises, arba kai nevykdomi Vyriausybės nutarimai, savo įgaliojimus vykdo pagal reikalą pasirinkdamas vieną iš reagavimo formų:
1) rašo motyvuotą teikimą vadovui to organo, kuris priėmė sprendimą ar potvarkį, ir reikalauja nedelsiant sustabdyti tokį sprendimą ar potvarkį ir svarstyti jo pakeitimo ar panaikinimo klausimą; kartu apie tai informuoja aukštesnįjį pagal pavaldumą savivaldybės organą.
